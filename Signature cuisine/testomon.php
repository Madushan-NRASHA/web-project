...
<html lang="en">
  <head>
    ...
    <!-- Style CSS -->
    <link rel="stylesheet" href="./testimonial-carousel/css/style.css">
  <main>
  ...
  <div class="container">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <p class="lh-lg">Best Food Best Tasty in One place</p>
            ...
            <span>CodeHim</span>
               ...
               <div class="carousel-item">
                   <div class="row p-4">
                    <div class="t-card">
                    <i class="fa fa-quote-left" aria-hidden="true"></i>
                    <p class="lh-lg">Best Italin Food i ever tastess </p>
           <i class="fa fa-quote-right" aria-hidden="true"></i><br>
           </div>
        <div class="row">
          ...
          <span>Public Gov bank</span>
               ...
               <div class="carousel-item">
                   <div class="row p-4">
                    <div class="t-card">
                    <i class="fa fa-quote-left" aria-hidden="true"></i>
                    <p class="lh-lg">Best Place To eat delicious foods</p>
                      <i class="fa fa-quote-right" aria-hidden="true"></i><br>
                    </div>
